...
export default function LineRow({ type, draw, index }: IProps) {
    ...
    return (
        <div className="grid grid-rows-2 gap-4 sm:grid-cols-2 sm:grid-rows-none">
            ...
            <div className="grid grid-cols-2 gap-2 sm:content-end">
                <button
                ...
                <button
                    className="flex h-12 w-full items-center justify-center rounded bg-slate-800 px-4 py-2 font-bold text-white hover:bg-slate-600"
